  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Render the same font links on the server and client. Rendering these
            only during SSR changes <head> during hydration, causing React to
            replace the document and discard React Router's critical CSS. */}
        <LoadFonts />
      </head>
