...
export function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <html lang="en">
      ...
      <body>
        {/* AuthProvider lives here, not in app/layout.jsx (like Language/QueryClient),
            because plugins/layouts.ts wraps *every* page.jsx with its own fresh copy of
            layout.jsx's providers -- navigating between pages fully unmounts and
            remounts them. That's invisible for Language (it round-trips through
            localStorage) and tolerable for QueryClient (just an emptier cache), but
            silently breaks auth: the in-memory session set on OTP success would vanish
            the instant `navigate()` swapped routes. This file (root.tsx) is React
