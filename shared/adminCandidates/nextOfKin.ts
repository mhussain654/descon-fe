...
/** True once at least one next-of-kin field has a non-blank value -- the point at which all four become required. False for every field blank, which is always valid (nothing recorded, or an intentional clear). */
